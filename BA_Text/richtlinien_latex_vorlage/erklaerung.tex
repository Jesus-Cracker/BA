...
%veröffentlichten und nicht veröffentlichten Schriften entnommen
...
%\includepdf{images/Formular_Eidesstattliche+Versicherung_neu_Declaration+of+Academic+Integr}
\chapter*{Eidesstattliche Versicherung}
\thispagestyle{empty}
Statt dieser Seite muss die unterschriebene eidesstattliche Versicherung in die Arbeit eingebunden werden. Die aktuell gültige Version kann im Formularschrank des ZPA gefunden werden:


\url{https://www.rwth-aachen.de/cms/root/studium/im-studium/pruefungsangelegenheiten/~ccwp/formularschrank-mit-suche-und-filter/?showall=1}
\newpage
%\begin{figure}[!ht]
%  \centering
