...
\usepackage[ngerman]{babel}              % Deutsche Silbentrennung ...
                                         ...
                                         % geladen werden.
\usepackage{scrlayer-scrpage}                    % Kopf- und Fusszeilen
...
\usepackage{tikz}												 % Zeichenpaket und Optionen für Bilder.
...
% dies nachinstalliert werden müsste.
...
\usepackage{acronym}										 
\usepackage{scrhack}										 % Beseitigt Inkompatibilitäten zwischen Komascript und Listings-Paket
...
\usepackage{ragged2e}										 % Links-/rechtsbündig und trotzdem passende Zeilenumbrüche
...
%* vom Benutzer geändert werden müssen. 																		  				*
%* 																																						  			*
%**************************************************************************************
...
%************************************************************************
%*																																			*
%* Für die Ausgabe mit pdflatex nötige Befehle zur sinnvollen Benutzung	*
...
\ifpdf
  ...
  \hypersetup{
                ...
                linkcolor=black,	% um link" -> false und "Text farbig" -> true 
				        citecolor=black,  % daher sind die Farbdefinitionen nötig um Links nicht
...
%*************************************************************
% Die folgenden zwei Zeilen werden benötigt sofern Matlab-	 *
% Plots eingebunden werden sollen														 *
%*************************************************************

\newlength\fheight											% benötigt zur Einbindung von Matlab-Plots 
\newlength\fwidth												% auskommentieren bei nichtbenutzen


%****************************************************************
% Die folgenden zwei Zeilen ändern die Größe der 	        	    *
% Unterschriften um eine klare Abgrenzung zum Text zu erreichen *
%****************************************************************

\setkomafont{caption}{\small}									% Bild-/Tabellenunterschrift ändern
...
%*******************************************************************
%* Vertikaler Abstand vor Chapter Überschrift ändern  						 *
%*******************************************************************
